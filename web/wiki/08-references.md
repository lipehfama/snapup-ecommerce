...
These references provide background for the architecture and recommendations in this wiki. Primary
project documentation is preferred over tutorials or third-party summaries.
...
- [Bun runtime and package scripts](https://bun.sh/docs/runtime)
...
- [Registering a service worker](https://vite-pwa-org.netlify.app/guide/register-service-worker)
- [Automatic service-worker updates](https://vite-pwa-org.netlify.app/guide/auto-update)
